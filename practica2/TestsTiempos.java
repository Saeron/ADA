 ...
 * frente a otros metodos de ordenacion
 *
 */
...
public class TestsTiempos {
	...
	public static void testResolverTodos(GeneradorVector<Integer> generador, String subtitulo) {
		...
		int numTests = 20; //numero de tests para cada tamauo
		int minTam = 0, maxTam = 2000, saltoTam = 25; //tamanos minimos, maximos y saltos
